(function ($) {
  var host = "http://localhost:9009"; //где бек
"use strict";
...
$(document).ready(function() {
  $.getJSON(host + "/category/main", function( data ) {
    var items = [];
    $.each( data, function( key, val ) {
      items.push( `<div class="col-md-6 col-lg-3">
